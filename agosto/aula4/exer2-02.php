...
do {
    ...
    echo "1- Inserir\n";
    echo "2- Listar\n";
    echo "3- Excluir pessoa cadastrada\n";
    echo "0- SAIR\n";
    ...
    switch ($opcao) {
        ...
        case 3:
            //listando as pessoas
            echo "Pessoas\n";
            foreach ($cadastro as $i => $p) {
               echo $i.": ". $p. "\n" ;
               
            }
            //informe qual pessoa deve ser excluida
            $excluido = readline("Informe qual pessoa deseja excluir do cadastro: ");
            //$excluido --;
            //excluir
            if ($excluido >= 0 && $excluido < count($cadastro)) {
                array_splice($cadastro, $excluido, 1);
                echo "Pessoa excluída do cadastro \n"; 
            }
            break;
